                            ...
                            <?php
                                include("../conexao.php"); 
                                            ...
                                            $vencimento = $_POST['vencimento'];
                                                    ...
                                                    $sql ="UPDATE liga SET nome='$nome', data='$data', hora='$hora', local='$local', clubes='$clubes', organizador='$organizador', facebook='$facebook', fone='$fone', inscricao='$inscricao', primeiro_lugar='$primeiro_lugar', segundo_lugar='$segundo_lugar', terceiro_lugar='$terceiro_lugar', quarto_lugar='$quarto_lugar', quinto_lugar='$quinto_lugar', data_upload='$data_upload', vencimento='$vencimento' where id='$id' ";
